...
# model.load_state_dict(torch.load("/home/czy/桌面/magx-main1/Codes/optimization/oursnew.pth", map_location=torch.device('cpu')))  # 加载权重
...
# 读取测试数据
test_df = pd.read_csv('/home/czy/桌面/magx-main1/secondy_test.csv')
# test_df = pd.read_csv('/home/czy/桌面/magx-main1/firstx_test.csv')
