        ...
        if not worklist.empty():
            ...
            if magcount == 1:
                ...
                if(len(resultslist)==300):
                    ...
                    #  test.to_csv("/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0401LM_test27_"+str(countnum)+".csv")
                     print("Exited")
                     countnum=countnum+1
                     resultslist=[]
...
def notification_handler(sender, data):
    ...
    if(len(resultslist1)==300):
        print("Output csv")
        test = pd.DataFrame(columns=name1,data=resultslist1)
        # test.to_csv("/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0401LMsensor27_"+str(countnum1)+".csv")
        print("Exited")
        countnum1=countnum1+1
        resultslist1=[]
