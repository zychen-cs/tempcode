    ...
    while True:
        if not worklist.empty():
            ...
            #     model.load_state_dict(torch.load('/home/czy/桌面/magx-main1/Codes/optimization/full_data_mlp_model.pth', map_location=torch.device('cpu')))
                model.load_state_dict(torch.load('/home/czy/桌面/magx-main1/Codes/optimization/1122full_data_mlp_model_v1.pth', map_location=torch.device('cpu')))
                model.eval()
                ...
                if(len(resultslist)==1000):
                     ...
                     test.to_csv("/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/1124MLP2_"+str(countnum)+".csv")
                     print("Exited")
                     countnum=countnum+1
                     resultslist=[]
                # current = [datetime.datetime.now()]
