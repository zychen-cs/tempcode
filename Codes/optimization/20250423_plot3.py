...
data = pd.read_csv('/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0423test_1_1.csv')
data = pd.read_csv('/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0616data_ours5_1.csv')
data = pd.read_csv('/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0616LMdiff_1_1.csv')
data = pd.read_csv('/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0621env5_N_1.csv')
# data = pd.read_csv('/home/czy/windows_disk/Users/26911/Documents/linux/trackingdata/0707watch_motion22_1.csv')
data = pd.read_csv('/media/czy/T7 Shield/mobicom_dataset/unseen_LM/0707watch_motion22_1.csv')
...
# env1_0621=[0.22,0.20,0.17,0.23,0.25,0.17,0.18,0.20,0.15,0.12,0.17,0.17,0.21,0.10,0.14,0.22,0.25,0.23,0.22,0.11,0.20,0.20,0.14,0.16,0.17,0.13]
env1_0621=[0.22,0.21,0.10,0.25,0.13]
env2_0621=[0.15,0.13,0.11,0.28,0.25]
env3_0621_1=[0.28,0.35,0.61,0.77,0.43]
env3_0621_2=[0.23,0.27,0.28,0.42,0.29]
env4_0621=[0.21,0.21,0.12,0.34,0.22]
env5_0621_1=[0.43,0.16,0.92,1.0,0.61]
env5_0621_2=[0.23,0.21,0.15,0.18,0.25]
# env1_0621 =  env1_0621
# print(env1_0621)
# print(np.mean(env1_0621))
# print(np.std(env1_0621))
# print(np.mean(np.array(env1_0621)*10))
# print(np.std(np.array(env1_0621)*10))
