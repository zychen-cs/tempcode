...
# model.load_state_dict(torch.load("/home/czy/桌面/magx-main1/Codes/optimization/0703finetune2.pth", map_location=torch.device('cpu')))  # 加载权重
...
test_df = pd.read_csv('/media/czy/T7 Shield/mobicom_dataset/noisetype4/noise_x/fourthx_test.csv')
...
for j in range (0,len(X_denoised)):
