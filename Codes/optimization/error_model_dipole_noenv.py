...
distance=[]
SNRstd= 10 * np.log10((column_max[20]-column_stds[20]) / abs(column_means[20]))
disID=0
snrID=0
disindex=0
snrindex=0
...
for i in range(0,len(sensor_data_np1)):
    ...
    if(column_means[1]>0):
        ...
        SNR= 10 * np.log10(abs(sensor_data_np1[i][1]-column_means[1]) / abs(column_stds[1]))
        SNR1= 10 * np.log10(abs(sensor_data_np1[i][4]-column_means[4]) / abs(column_stds[4]))
        SNR2= 10 * np.log10(abs(sensor_data_np1[i][7]-column_means[7]) / abs(column_stds[7]))
        SNR3= 10 * np.log10(abs(sensor_data_np1[i][10]-column_means[10]) / abs(column_stds[10]))
        SNR4= 10 * np.log10(abs(sensor_data_np1[i][13]-column_means[13]) / abs(column_stds[13]))
        SNR5= 10 * np.log10(abs(sensor_data_np1[i][16]-column_means[16]) / abs(column_stds[16]))
        SNR6= 10 * np.log10(abs(sensor_data_np1[i][19]-column_means[19]) / abs(column_stds[19]))
        SNR7= 10 * np.log10(abs(sensor_data_np1[i][22]-column_means[22]) / abs(column_stds[22]))
        SNR8= 10 * np.log10(abs(sensor_data_np1[i][25]-column_means[25]) / abs(column_stds[25]))
        SNR9= 10 * np.log10(abs(sensor_data_np1[i][28]-column_means[28]) / abs(column_stds[28]))
